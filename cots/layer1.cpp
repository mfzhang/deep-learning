...
int main(int argc, char **argv)
{
    ...
    float layer1_learning_rate = -0.5;
    float layer1_learning_rate_alpha = -0.0005;
    float layer1_alpha = 0.3;
...
//             layer1_learning_rate_alpha, layer1_alpha, layer1_momentum, layer1_lambda, "./binaryfile/minst.bin", "./binaryfile/layer1out_unlabeled.bin");
    ...
    if(me == 0)    
    {
        cout << "the learning rate is :" << layer1_learning_rate << "\n" << "the layer1_alpha is :" << layer1_alpha << endl; 
