...
int main(int argc, char **argv)
{
    ...
    layer1.init(layer1_input_size, layer1_input_channels, layer1_filter_size, layer1_filter_channels, layer1_batch_size, \
            ...
            layer1_learning_rate_alpha, layer1_alpha, layer1_momentum, layer1_lambda, "./binaryfile/mnist_layer1_");
    ...
    ss << me;
    ss >> weight_name;
    weight_name = "./binaryfile/weight/mnist_layer1_" + weight_name + ".bin";
